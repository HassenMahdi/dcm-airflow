...
class TransformationHandler(BaseTransformationHandler):
    transformation_types = ["statistics_hcp", "estimation","statistics","correlation","check-social","rsu-check", "hash-by-category", "filter", "find-replace", "merge", "replace", "delete-rows", "default-value", "split", "calculator", "format-date", "groupby", "pycode", "hash"]
